  ...
  template: `
    ...
    <header class="bg-white">
      <nav class="mx-auto flex max-w-7xl items-center justify-between p-6 lg:px-8" aria-label="Global">
        ...
        <div class="flex lg:flex-1 gap-x-2">

          <button type="button"
                  (click)="sidebar.onToggleSidenav()"
                  class="-m-2.5 inline-flex items-center justify-center rounded-md p-2.5 text-gray-700">
            <mat-icon class="text-red-500">menu</mat-icon>
          </button>


          <a href="/" class="-m-1.5 p-1.5 flex gap-x-4">
            <span class="text-xl text-red-500">TOW TRUCK</span>
            🚚
          </a>
        ...
        <div class="hidden lg:flex lg:gap-x-12">
          <div class="relative">
            ...
            -->
            <div
              class="absolute top-full -left-8 z-10 mt-3  w-screen max-w-md overflow-hidden rounded-3xl bg-white ring-1 shadow-lg ring-gray-900/5 hover:opacity-100 opacity-0">
              <div class="p-4">
          ...
          <a href="#" class="text-sm/6 font-semibold text-gray-900">Promoters</a>
          <a href="#" class="text-sm/6 font-semibold text-gray-900">Incidents</a>
          ...
          <div class="mt-6 flow-root">
            <div class="-my-6 divide-y divide-gray-500/10">
              <div class="space-y-2 py-6">
                ...
                <a href="#"
                   class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Promoters</a>
                <a href="#"
                   class="-mx-3 block rounded-lg px-3 py-2 text-base/7 font-semibold text-gray-900 hover:bg-gray-50">Incidents</a>
                <a href="#"
